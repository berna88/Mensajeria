...
<div class="tab-pane fade active" id="pills-seccion2" role="tabpanel" aria-labelledby="pills-seccion-tab2">
	<section class="row align-items-center justify-content-center no-gutters" style="height: auto;">
		<article class="col-12 col-sm-12 col-md-5 col-lg-4 col-xl-3">
			...
			<h6 class="text-center font-weight-light">El formato deberá entregarse fisicamente en el área de Mensajería</h6>
			<a download target="_blank" href='<%=request.getContextPath()+"/formato/FormatoEnvios2019.doc"%>' class="mt-50 border border-0 w-75 pt-1 pb-1 font-weight-normal text-center" style="background: #cbb874;color: black;display: block;margin: auto;" >Descargar formato</a>
		</article>
	</section>
</div>